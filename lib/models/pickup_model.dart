...
enum PickupStatus { pending, accepted, inProgress, arrived, completed, failed }
...
extension PickupStatusExt on PickupStatus {
  String get value {
    switch (this) {
      ...
      case PickupStatus.arrived:    return 'Arrived';
  ...
  static PickupStatus fromString(String s) {
    switch (s.toLowerCase().replaceAll(' ', '')) {
      ...
      case 'arrived':    return PickupStatus.arrived;
...
class PickupModel {
  ...
  factory PickupModel.fromJson(Map<String, dynamic> json) {
    return PickupModel(
      ...
      notes:            json['notes'],
      disposalProofUrl: json['disposal_proof_url'],
    );
  }

  PickupModel copyWith({PickupStatus? status, String? notes, String? disposalProofUrl}) {
    return PickupModel(
      id:               id,
      siteId:           siteId,
      siteName:         siteName,
      ...
      disposalProofUrl: disposalProofUrl ?? this.disposalProofUrl,
    );
  }
}
