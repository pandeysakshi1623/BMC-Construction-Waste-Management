...
class MyApp extends StatelessWidget {
  ...
  static final _routes = <String, WidgetBuilder>{
    ...
    '/citizen/report':             (_) => const ReportComplaintScreen(siteId: '', siteName: 'Manual Report'),
    // Profile (all roles)
    '/contractor/profile':         (_) => const ProfileScreen(),
    '/citizen/profile':            (_) => const ProfileScreen(),
    '/driver/profile':             (_) => const ProfileScreen(),
    '/bmc/profile':                (_) => const ProfileScreen(),
    // Driver
